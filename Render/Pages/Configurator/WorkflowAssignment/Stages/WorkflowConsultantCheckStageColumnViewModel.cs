...
public class WorkflowConsultantCheckStageColumnViewModel : WorkflowStageColumnViewModel
    {
        ...
        public WorkflowConsultantCheckStageColumnViewModel(Stage stage, IReadOnlyList<Team> teamList,
            ...
            base(stage, workflow, updateStageColumnCallback, viewModelContextProvider, projectName)
        {
            ...
            var transcribePassageActiveSetting = steps.Last(x => x.Role == Roles.Transcribe).
                StepSettings.Settings.First(x => x.SettingType == SettingType.DoPassageTranscribe);
            ...
            var secondTranscribeRetellActiveSetting = secondTranscribeRetell.
                StepSettings.Settings.First(x => x.SettingType == SettingType.IsActive);
            ...
            Disposables.Add(this.WhenAnyValue(
                ...
                x => x.ConsultantAssignmentCard.UserCardViewModel).
                Subscribe(x =>
                {
                    AllWorkAssigned =
