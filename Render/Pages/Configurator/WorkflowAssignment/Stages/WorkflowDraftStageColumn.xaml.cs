...
public partial class WorkflowDraftStageColumn
{
    public WorkflowDraftStageColumn()
    {
        InitializeComponent();
        ...
        this.WhenActivated(d =>
        {
            ...
            d(this.BindCommand(ViewModel, vm => vm.AddTeamCommand, v => v.AddTeamButtonGestureRecognizer));
