...
namespace Render.Sequencer.Core.Utils.Collection;
...
public class ObservableRangeCollection<T> : ObservableCollection<T>
{
    ...
    public void ResetRange(params T[] items)
    {
        AddRange(items, NotifyCollectionChangedAction.Reset);
    }

    public void AddRange(params T[] items)
    {
        AddRange(items, NotifyCollectionChangedAction.Add);
    }
    ...
    /// <summary>
    /// Clears the current collection withound sending notifications
    /// </summary>
